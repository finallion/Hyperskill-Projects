...
public class Main {
    ...
    public static BigInteger calculate(Deque<String> input) {
        //if you want to handle integers instead of BigInteger, you only need to change this method
        //pay attention to the operation; these need adjustment when switching back
